...
| `files`              |  array   | Android, iOS  | An array of file paths or URLs to be shared (e.g., images, documents) or even base64 data URIs.  |
...
```javascript
   ...
   UTILITY.SHARE("test message", "test subject", ["https://example.com/image.png, https://example.com/animation.pdf"], "https://www.google.com/", "share title", "com.test.share")
